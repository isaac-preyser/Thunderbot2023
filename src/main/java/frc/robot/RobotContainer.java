...
// The robot's subsystems
    public final GyroSubsystem m_gyroSubsystem = new GyroSubsystem(Robot.m_imu);
...
private final XboxController driverController = new XboxController(Constants.OIConstants.kDriverControllerPort);
  ...
  SendableChooser<Double> m_targetAngle = new SendableChooser<>();
  /**
  ...
  */
  private RobotContainer() {
    ...
    SmartDashboard.putData("Autonomous Command", new AutonomousCommand(m_driveSubsystem, 4, m_gyroSubsystem));
    ...
    m_chooser.setDefaultOption("Autonomous Command", new AutonomousCommand(m_driveSubsystem, 4, m_gyroSubsystem));
...
// Create some buttons
final JoystickButton buttonCloseHand = new JoystickButton(driverController, XboxController.Button.kLeftBumper.value);        
buttonCloseHand.onTrue(new CloseHand( m_armSubsystem ).withInterruptBehavior(InterruptionBehavior.kCancelSelf));
                        SmartDashboard.putData("buttonCloseHand",new CloseHand( m_armSubsystem )); 
buttonCloseHand.onFalse(new SetArmCommand(m_armSubsystem, //
() -> driverController.getLeftTriggerAxis(),
() -> driverController.getRightTriggerAxis() //
  )
);

final JoystickButton buttonOpenHand = new JoystickButton(driverController, XboxController.Button.kRightBumper.value);        
...
buttonOpenHand.onFalse(new SetArmCommand(m_armSubsystem, //
() -> driverController.getLeftTriggerAxis(),
() -> driverController.getRightTriggerAxis() //
  )
);
