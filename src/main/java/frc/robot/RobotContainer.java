...
public class RobotContainer {
  ...
  private static ADIS16470_IMU m_imu = new ADIS16470_IMU(ADIS16470_IMU.IMUAxis.kX, SPI.Port.kMXP, ADIS16470_IMU.CalibrationTime._4s);
    // BEGIN AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=DECLARATIONS
// The robot's subsystems
    public final GyroSubsystem m_gyroSubsystem = new GyroSubsystem(m_imu);
...
private final XboxController driverController = new XboxController(Constants.OIConstants.kDriverControllerPort);
  ...
  */
  private RobotContainer() {
    ...
    m_chooser.setDefaultOption("Autonomous Command", new AutoDrive(m_driveSubsystem, 4));
