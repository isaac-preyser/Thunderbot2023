...
private final XboxController driverController = new XboxController(Constants.OIConstants.kDriverControllerPort);
  ...
  */
  private RobotContainer() {
    ...
    SmartDashboard.putData("Autonomous Command", new AutonomousCommand(m_driveSubsystem));
    ...
    m_chooser.setDefaultOption("Autonomous Command", new AutonomousCommand(m_driveSubsystem));
...
//set raise arm to right bumper and lower arm to left bumper. 
final JoystickButton buttonRaiseArm = new JoystickButton(driverController, XboxController.Button.kRightBumper.value);
buttonRaiseArm.onTrue(new RaiseArm( m_armSubsystem ).withInterruptBehavior(InterruptionBehavior.kCancelSelf));
                        SmartDashboard.putData("buttonRaiseArm",new RaiseArm( m_armSubsystem ));
buttonRaiseArm.onFalse(new SetArmCommand(m_armSubsystem, //
() -> driverController.getLeftTriggerAxis(),
() -> driverController.getRightTriggerAxis() //
  )
);
final JoystickButton buttonLowerArm = new JoystickButton(driverController, XboxController.Button.kLeftBumper.value);
buttonLowerArm.onTrue(new LowerArm( m_armSubsystem ).withInterruptBehavior(InterruptionBehavior.kCancelSelf));
                        SmartDashboard.putData("buttonLowerArm",new LowerArm( m_armSubsystem ));
buttonLowerArm.onFalse(new SetArmCommand(m_armSubsystem, //
() -> driverController.getLeftTriggerAxis(),
() -> driverController.getRightTriggerAxis() //
  )
);
